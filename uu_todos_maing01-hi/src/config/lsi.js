const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuTodos",
      en: "About application uuTodos",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuTodos.",
      en: "You can buy your own uuTodos.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuTodos.",
      en: "You don't have rights to initialize this uuTodos.",
    },
  },
